...
endee_client = Endee()
endee_client.set_base_url("http://localhost:8080/api/v1")
...
query = st.text_area(
    ...
    placeholder="e.g. I know Python, machine learning basics, and data analysis. Looking for a tech internship.",
    height=100,
)
...
if search_btn and query:
    ...
    if results:
        ...
        st.warning("No results found. Try describing your skills differently.")
